...
<table class="table">@foreach($members as $member)<tr><td>{{ $member->full_name }}</td><td>{{ $member->email }}</td><td><a href="{{ route('members.edit',$member) }}">Modifier</a></td></tr>@endforeach</table>
@endsection
