...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <p class="text-uppercase mb-1" style="font-size:.65rem;letter-spacing:.1em;color:var(--muted);font-weight:600;">Gestion</p>
        <h1 style="font-family:'DM Serif Display',Georgia,serif;font-size:1.6rem;margin:0;color:var(--text);">Adhérents</h1>
    </div>
    <a class="btn btn-sm btn-dark" href="{{ route('members.create') }}">
...
<div class="card">
    <div class="table-responsive">
        <table class="table mb-0">
            ...
            @forelse($members as $member)
                <tr>
                    ...
                    <td style="text-align:right;">
                        <a class="btn btn-sm btn-outline-secondary" href="{{ route('members.edit', $member) }}" style="cursor:pointer;">
            ...
            @empty
                <tr>
                    <td colspan="3" style="text-align:center;padding:40px;color:var(--muted);font-size:.875rem;">
